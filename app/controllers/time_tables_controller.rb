class TimeTablesController < ApplicationController
  ...
  private
    ...
    def time_table_params
      params.require(:time_table).permit(:week, :day, :date, :start_time, :end_time, :period, :teacher, :room_number, :subject, :year_group, :student_name, :equipment, :assignment_due, :user_id)
    end
end
